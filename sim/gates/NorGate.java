...
public class NorGate extends LogicGate {
    ...
    public NorGate(String id, int x, int y) {
        super(id, x, y, TOTAL_WIDTH, BODY_HEIGHT, "NOR");

        // NOR Gate has 2 input pins and 1 output pin
    ...
    // Loading Constructor
    public NorGate(String id, int x, int y, List<Integer> inPins, List<Integer> outPins) {
        super(id, x, y, TOTAL_WIDTH, BODY_HEIGHT, "NOR", inPins, outPins);
    }
