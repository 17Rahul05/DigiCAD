...
public class AndGate extends LogicGate {
    ...
    public AndGate(String id, int x, int y) {
        super(id, x, y, BODY_WIDTH, BODY_HEIGHT, "AND");

        // AND Gate has 2 input pins and 1 output pin
    ...
    // Loading Constructor
    public AndGate(String id, int x, int y, List<Integer> inPins, List<Integer> outPins) {
        super(id, x, y, BODY_WIDTH, BODY_HEIGHT, "AND", inPins, outPins);
    }
