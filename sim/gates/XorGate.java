...
public class XorGate extends LogicGate {
    ...
    public XorGate(String id, int x, int y) {
        super(id, x, y, BODY_WIDTH, BODY_HEIGHT, "XOR");

        // XOR Gate has 2 input pins and 1 output pin
    ...
    // Loading Constructor
    public XorGate(String id, int x, int y, List<Integer> inPins, List<Integer> outPins) {
        super(id, x, y, BODY_WIDTH, BODY_HEIGHT, "XOR", inPins, outPins);
    }
